...
public class BackgroundParallax : MonoBehaviour
{
	...
	public float parallaxScaleX = -2f;					// The proportion of the camera's movement to move the backgrounds by.
	public float parallaxScaleY = -1f;
	public float parallaxReductionFactor = 1f;		// How much less each successive layer should parallax.
	public float smoothing = 8f;						// How smooth the parallax effect should be.
	...
	void Awake ()
	{
		// A opcao de pegar a camera automaticamente está comentada porque está sendo utilizado pois
		// existir mais de uma camera na cena.
